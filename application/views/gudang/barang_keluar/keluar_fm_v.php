      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <div class="input-group-btn">
            <button data-toggle="modal" data-target="#modal_barang" type="button" class="btn btn-primary"><i class="fa fa-folder-open-o"></i></button>
          </div>
        </div>
      </div>
      <div class="form-group">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <div class="input-group-btn">
            <button data-toggle="modal" data-target="#modal_supplier" type="button" class="btn btn-primary"><i class="fa fa-folder-open-o"></i></button>
          </div>
        </div>
      </div>
      <div class="form-group">
...
<div class="modal fade" id="modal_supplier" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-close"></i></button>
              <h4 class="modal-title" id="myModalLabel"><i class="fa fa-hdd-o fa-fw"></i>Browse Data Sales</h4>
          </div>
          <div class="modal-body">
            <div class="mailbox-messages table-responsive">
