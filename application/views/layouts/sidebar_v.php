    ...
    <ul class="sidebar-menu">
      ...
      <li id="master" class="treeview">
        ...
        <ul class="treeview-menu">
          <li id="barang"><a href="<?php echo base_url() ?>Gudang/barang"><i class="fa fa-circle-o"></i> Data Barang</a></li>
          <li id="supplier"><a href="<?php echo base_url() ?>Gudang/supplier"><i class="fa fa-circle-o"></i> Data Supplier</a></li>
          <li id="sales"><a href="<?php echo base_url() ?>Gudang/sales"><i class="fa fa-circle-o"></i> Data Sales</a></li>
        </ul>
      </li>
      <li id="transaksi" class="treeview">
        ...
        <ul class="treeview-menu">
          <li id="masuk"><a href="<?php echo base_url() ?>Transaksi/masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
          <li id="keluar"><a href="<?php echo base_url() ?>Transaksi/keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
        </ul>
      </li>
